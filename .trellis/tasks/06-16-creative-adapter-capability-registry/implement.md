...
13. [ ] fake-secret corpus tests: submit/poll/fetch/logs/metrics/task DTO/Trellis artifacts/build outputs do not contain secret corpus. _(Partial: submit/fetch/sync DTO assertions prove no private mock URL / signed-query markers/generic task internals; full logs/metrics/artifacts/build corpus remains pending.)_
